...
function loadInstrContent() {
    var instrContent = [
        ...
        /* ind1 */ `<p> In this quick experiment, you will see a number appear on screen for a short amount of time. You should memorize it. </p> <p>Then, after it disappears, this empty frame will appear on screen. Whenever you see this frame, <i>you should get ready</i> for what comes after. <img src = "${stimFolder}frame.png" style="width: ${imgWidth}px; display: block; margin: 0 auto;"></p>`,
        /* ind2 */ `<p> Shortly after the frame appears, an image will flash on the screen for an <i>extremely short amount of time</i>. Your task is to take in as many details as possible, and <b>remember this image</b> while still holding on to the number. </p> </div>It will be difficult! And that is as intended.`,
        /* ind3 */ `<p>After this image flashes on screen, it will get immediately covered up by the chaotic image below, just to make it hard for you to remember the first image! <b>Ignore this chaotic image</b>, as it will disappear quickly as well.<img src="${stimFolder}mask_v3.png" style="width: ${imgWidth}px; display: block; margin: 0 auto;"></p>`,
        /* ind4 */ `<p> Once all the images disappear, you will asked a question about some aspect of the first image.
